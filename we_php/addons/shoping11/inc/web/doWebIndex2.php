...
/* 
 * To change this license header, choose License Headers in Project Properties.0
...
global $_GPC, $_W;
		...
		if ($operation == 'post') {
			...
			if (empty($category)) {
				message('抱歉，请您先添加商品分类！', $this->createWebUrl('index2', array('op' => 'post')), 'error');
			}
			if (checksubmit('submit')) {
				if (empty($_GPC['goodsname'])) {
					message('请输入商品名称！');
				}
                                                         if(empty($_GPC['goodssn1'])){
                                                             message('请输入商品规格');
                                                         }
				...
				$data = array(
					...
					'size' => $_GPC['goodssn1'],
                                                                          'total' => intval($_GPC['total1']),
					'size1' => $_GPC['goodssn2'],
                                                                          'total1' => intval($_GPC['total2']),
					'size2' => $_GPC['goodssn3'],
                                                                          'total2' => intval($_GPC['total3']),
					'size3' => $_GPC['goodssn4'],
                                                                          'total3' => intval($_GPC['total4']),
					'size4' => $_GPC['goodssn5'],
                                                                          'total4' => intval($_GPC['total5']),
					'unit' => $_GPC['unit'],
...
//				}
				...
				message('商品更新成功！', $this->createWebUrl('index2', array('op' => 'display', 'id' => $id)), 'success');
			}
