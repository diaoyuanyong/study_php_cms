...
<div class="box">
    ...
    <li>官方网站：<a href="http://www.haoid.cn" class="blue">好站长资源网</a></li>

    <li class="red">[当前系统版本]：微擎 V <?php  echo $ver;?></li>
	<?php  if($lastver == $ver) { ?>
	<li class="red">[最新系统版本]：微擎 V <?php  echo $ver;?> （恭喜, 你的程序已经是最新版本）</li>
	<?php  } ?>
	<?php  if($lastver != $ver) { ?>
	<li class="red">[下一个系统版本]：：微擎 V <?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="chanage();" class="btn btn-primary">查看版本</button></li>
...
<!-- WPA Button End -->
        <?php  } else { ?>
           <i class="fa fa-refresh"></i> 授权版本：好站长资源网商业版 &nbsp;免费更新服务截止：(<?php  echo date("Y-m-d", $domain_time);?>)
		 <?php  } ?>
		</div>
...
<div class="box">
	<h3><i class="fa fa-refresh"></i> 功能模块分享</h3>
     <div class="alert alert-info" style="line-height:20px;margin-top:8px;min-height:328px;">
		<script type="text/javascript" src="http://www.haoid.cn/api.php?mod=js&bid=41"></script>
    </div>
</div>
