...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('index6', array('op' => 'display'))?>">管理</a></li>
</ul>
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td style="text-align:right;">
						<a href="<?php  echo $this->createWebUrl('index1', array('id' => $item['order']['id'], 'op' => 'detail'))?>">订单详情</a>
						&nbsp;&nbsp;
						<a href="<?php  echo $this->createWebUrl('index6', array('id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;">删除</a>
					</td>
				</tr>
				<?php  } } ?>
				</tbody>
