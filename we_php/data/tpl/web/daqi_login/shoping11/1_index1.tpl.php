...
<ul class="nav nav-tabs">
	...
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display'))?>">全部订单</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '1' && ( $sendtype=='1' || $sendtype=='0')) { ?> class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => 1))?>">待发货</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '1' && $sendtype == '2') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => '1', 'sendtype' => 2))?>">待自提</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '0') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => 0))?>">待付款</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '2') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => 2))?>">待收货</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '3') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => 3))?>">已完成</a>
	</li>
	<li <?php  if($operation == 'display' && $status == '-1') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'display', 'status' => -1))?>">已关闭</a>
	</li>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
				...
				<input type="hidden" name="do" value="index1" />
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td style="text-align:right;">
						<a href="<?php  echo $this->createWebUrl('index1', array('op' => 'detail', 'id' => $item['id']))?>" class="btn btn-success btn-sm">查看订单</a>
						<a href="<?php  echo $this->createWebUrl('index1', array('id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');"
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td>
							<a href="<?php  echo $this->createWebUrl('index2', array('id' => $goods['id'], 'op' => 'post'))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
							<a href="<?php  echo $this->createWebUrl('index1', array('id' => $id, 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
						</td>
					</tr>
					<?php  } } ?>
					<tr>
