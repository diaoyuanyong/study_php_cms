...
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品规格-1</label>
	<div class="col-sm-4 col-xs-12">
		<input type="text" name="goodssn1" id="goodssn" class="form-control" value="<?php  echo $item['size'];?>" />
	</div>
</div>

<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">库存1</label>
	<div class="col-sm-6 col-xs-12">
		<div class="input-group">
			<input type="text" name="total1" id="total" class="form-control" value="<?php  echo $item['total'];?>" />
...
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品规格-2</label>
	<div class="col-sm-4 col-xs-12">
		<input type="text" name="goodssn2" id="goodssn" class="form-control" value="<?php  echo $item['size1'];?>" />
	</div>
</div>

<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">库存-2</label>
	<div class="col-sm-6 col-xs-12">
		<div class="input-group">
			<input type="text" name="total2" id="total" class="form-control" value="<?php  echo $item['total1'];?>" />
			<span class="input-group-addon">件</span>
		</div>
		<span class="help-block">当前商品的库存数量</span>
	</div>
...
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品规格-3</label>
	<div class="col-sm-4 col-xs-12">
		<input type="text" name="goodssn3" id="goodssn" class="form-control" value="<?php  echo $item['size2'];?>" />
	</div>
</div>

<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">库存-3</label>
	<div class="col-sm-6 col-xs-12">
		<div class="input-group">
			<input type="text" name="total3" id="total" class="form-control" value="<?php  echo $item['total2'];?>" />
			<span class="input-group-addon">件</span>
		</div>
		<span class="help-block">当前商品的库存数量</span>
	</div>
...
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品规格-4</label>
	<div class="col-sm-4 col-xs-12">
		<input type="text" name="goodssn4" id="goodssn" class="form-control" value="<?php  echo $item['size3'];?>" />
	</div>
</div>

<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">库存-4</label>
	<div class="col-sm-6 col-xs-12">
		<div class="input-group">
			<input type="text" name="total4" id="total" class="form-control" value="<?php  echo $item['total3'];?>" />
			<span class="input-group-addon">件</span>
		</div>
		<span class="help-block">当前商品的库存数量</span>
	</div>
...
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">商品规格-5</label>
	<div class="col-sm-4 col-xs-12">
		<input type="text" name="goodssn5" id="goodssn" class="form-control" value="<?php  echo $item['size4'];?>" />
	</div>
</div>

<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">库存-5</label>
	<div class="col-sm-6 col-xs-12">
		<div class="input-group">
			<input type="text" name="total5" id="total" class="form-control" value="<?php  echo $item['total4'];?>" />
			<span class="input-group-addon">件</span>
		</div>
		<span class="help-block">当前商品的库存数量</span>
	</div>
