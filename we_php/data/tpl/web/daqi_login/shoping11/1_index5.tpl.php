...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('index5',array('op' =>'display'))?>">配送方式</a></li>
	<li<?php  if(empty($dispatch['id']) && $operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('index5',array('op' =>'post'))?>">添加配送方式</a></li>
	<?php  if(!empty($dispatch['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('index5',array('op' =>'post','id'=>$dispatch['id']))?>">编辑配送方式</a></li> <?php  } ?>
</ul>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:left;">
						<a href="<?php  echo $this->createWebUrl('index5', array('op' => 'post', 'id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="修改"><i class="fa fa-pencil"></i></a>
						<a href="<?php  echo $this->createWebUrl('index5', array('op' => 'delete', 'id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
