...
<head>
    ...
    <title>门店列表</title>
    <link data-turbolinks-track="true" href="<?php echo RES;?>/mobile/diandan/assets/diandanbao/weixin.css?v=1" media="all" rel="stylesheet">
    <style type="text/css">
        @media screen {
        .smnoscreen {
            display: none
...
<script src="<?php echo RES;?>/mobile/diandan/assets/diandanbao/jquery-1.11.3.min.js"></script>
