		...
		<div class="shopcart-item-detail">
			...
			<div class="clearfix">
				<div class="input-group pull-left">
					...
					<span class="input-group-btn">
						<button class="btn btn-default btn-sm" type="button" onclick="addNum(<?php  echo $item['id'];?>,<?php  if($goods['max'] == 0) { ?><?php  echo $goods['total'];?><?php  } else { ?><?php  echo min($goods['total'], $goods['maxbuy'])?><?php  } ?>)"><i class="fa fa-plus"></i></button>
					</span>
				</div>
